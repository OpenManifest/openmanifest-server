...
ActiveRecord::Schema.define(version: 20_210_823_132_627) do
  ...
  create_table 'notifications', force: :cascade do |t|
    ...
    t.index %w[resource_type resource_id], name: 'index_notifications_on_resource'
  ...
  create_table 'orders', force: :cascade do |t|
    ...
    t.float 'amount'
    t.string 'title'
    t.index %w[buyer_type buyer_id], name: 'index_orders_on_buyer'
    t.index ['dropzone_id'], name: 'index_orders_on_dropzone_id'
    t.index %w[item_type item_id], name: 'index_orders_on_item'
    t.index %w[seller_type seller_id], name: 'index_orders_on_seller'
  end
  ...
  create_table 'transactions', force: :cascade do |t|
    ...
    t.index %w[receiver_type receiver_id], name: 'index_transactions_on_receiver'
    t.index %w[sender_type sender_id], name: 'index_transactions_on_sender'
